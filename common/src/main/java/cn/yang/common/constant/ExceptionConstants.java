...
public class ExceptionConstants {
    ...
    public static final String CONNECTION_EXCEPTION="connection exception happens";
    ...
    public static final String COMMAND_ERROR="Command must implements ICommand and only have one interface";
    ...
    public static final String GENERATOR_NOT_FOUND="sequence generator is not found";
